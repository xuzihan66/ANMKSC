function [Mu , Z , flag , TotalObj] = LMKCNew(KHL , M1 ,  Alpha_C , Beta_C , Gamma_C , lanbad,L , LargestIteration)
...
while Iter < LargestIteration && flag == 0
    ...
    Obj = ObjCalculation(Mu , M1 , M2 , Alpha_C, Beta_C,lanbad, Gamma_C , Z , L);
    Iter = Iter + 1;
    TotalObj(Iter) = Obj;
